...
export function AuthButtons() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-lg border border-[rgba(200,81,44,0.35)] bg-white px-3 py-1.5 text-sm text-[#2C2C2A] transition-colors hover:bg-[rgba(200,81,44,0.05)]"
    >
      <GoogleIcon />
      {t('signIn')}
    </button>
