...
contract RSendForwarderV2 is ReentrancyGuard, Ownable {
    ...
    receive() external payable nonReentrant {
        ...
        require(rule.active, "No active rule");
        require(msg.value >= rule.minThreshold, "Amount below minWei threshold");
