...
/**
 * RSendCCIPReceiverV2 — Riceve token cross-chain e distribuisce al recipient.
 *
 * Changes from V1:
 *   - Zero-recipient check after abi.decode to prevent token burns.
 *
...
contract RSendCCIPReceiverV2 is Ownable {
