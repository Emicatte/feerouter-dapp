...
/**
 * FeeRouterV5.sol — Multi-Signer Oracle + Emergency Rescue
 *
 * Changes from V4_1:
 *   - Single oracleSigner replaced by threshold-of-N multi-sig oracle.
 *   - _verifyOracle accepts bytes[] signatures, requires >= threshold unique
 *     valid signers in ascending address order.
 *   - setOracleSigners(address[], uint8) replaces setOracleSigner(address).
 *
 * Invariati da V4_1:
...
contract FeeRouterV5 is Ownable, ReentrancyGuard {
    ...
    // ══════════════════════════════════════════════════════════════════════
    //  3. transferWithOracle — ERC20 direct
    // ══════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════
    //  4. transferETHWithOracle — ETH direct
    // ══════════════════════════════════════════════════════════════════════
