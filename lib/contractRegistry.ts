...
// Token condivisi Base Mainnet + Base Sepolia (stessi indirizzi)
...
const REGISTRY: { [key: number]: NetworkRegistry } = {
  ...
  // ── Base Sepolia — stessi token di Base Mainnet ────────────────────────
  84532: {
    chainId:       84532,
    ...
    tokens:        BASE_TOKENS,  // stessi indirizzi — su Sepolia i contratti ERC20 non esistono ma la UI li mostra
  },
